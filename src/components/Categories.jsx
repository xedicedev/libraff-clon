...
const BOOKS_DATA = [
  ...
  { id: 8, title: 'Səfillər', categoryId: 'classics', price: 22.00, image: 'https://oopbook.com/wp-content/uploads/2023/08/Sefil.webp' },
  { id: 9, title: 'Cinayət və Cəza', categoryId: 'classics', price: 17.50, image: 'https://static.insales-cdn.com/r/KCOgwF0Alp0/rs:fit:570:570:1/q:80/plain/images/products/1/4350/171069694/43ccb52c03c85c71e64c12b4f2f67cb7.jpg@jpg' },
  ...
  { id: 21, title: 'Qraf Monte-Kristo', categoryId: 'novels', price: 24.00, image: 'https://cdn.insales-shop.ru/images/products/1/971/526525387/Duma_Qraf_Monte-Kristo_Esas.png' },
  { id: 22, title: 'Martin İden', categoryId: 'novels', price: 15.00, image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT4umHCfD5cVxKMpSnzQxpVx8Si4T9NP-D-Fy-MIxk56uMIXSyKWGqKxmo&s=10' },
  ...
  { id: 24, title: 'Balaca Şahzadə', categoryId: 'discounts', price: 6.50, image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRalbsxZl-W1-dcBPKokSLPcs9zI-WltjxXq26tn6Zr3UZCH-NWNDwieMsJ&s=10' },
  ...
  return (
    <section style={{ backgroundColor: '#f8fafc', padding: '40px 24px', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        {/* KLİKLƏNƏN KATEQORİYANIN KİTABLARI */}
        {selectedCategory && (
